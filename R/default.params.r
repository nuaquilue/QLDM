...
#' If FALSE, AAC level it is calculated only once, durgin the first time step}
#'    \item{\code{timber.supply}: String to indicate the unit of timber supply calculation, either "area.based" or "volume.based"}
